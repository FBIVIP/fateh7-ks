...
The script never reboots the device. It updates /data/misc/the_next_xx/keymint and
/data/misc/the_next_xx/inject, then requests the module daemons to restart through the
...
REMOTE_DIR = "/data/misc/the_next_xx"
