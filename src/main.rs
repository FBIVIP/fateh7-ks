...
const OMK_ROOT_DIR: &str = "/data/misc/the_next_xx";
const OMK_DATA_DIR: &str = "/data/misc/the_next_xx/data";
const OMK_CONFIG_PATH: &str = "/data/misc/the_next_xx/config.toml";
const OMK_KEYBOX_PATH: &str = "/data/misc/the_next_xx/keybox.xml";
const OMK_KEYMINT_LOG_PATH: &str = "/data/misc/the_next_xx/keymint.log";
const OMK_KEYMINT_LOG_ROTATED_PATH: &str = "/data/misc/the_next_xx/keymint.log.1";
const OMK_INJECTOR_LOG_PATH: &str = "/data/misc/the_next_xx/injector.log";
const OMK_INJECTOR_LOG_ROTATED_PATH: &str = "/data/misc/the_next_xx/injector.log.1";
const OMK_KEYMINT_LEGACY_LOCK_PATH: &str = "/data/misc/the_next_xx/keymint.log.lock";
const OMK_INJECTOR_LEGACY_LOCK_PATH: &str = "/data/misc/the_next_xx/injector.log.lock";
...
fn prepare_android_storage() {
    ...
    for file in [
        OMK_CONFIG_PATH,
        "/data/misc/the_next_xx/config.toml.bak",
        OMK_KEYBOX_PATH,
